...
% 
Its predictions are confirmed by many experiments performed since the second half of the 20${}^\text{th}$ century at scales extending over several orders of magnitude.
% 
...
\end{linenomath*}
% 
Extending this calculation beyond the leading order is more complicated, and so is including the the finite quark mass effects.
% 
