...
\tk{double-check integration of first paragraph.}
...
% 
Firstly, up until now, the loop has not been observed experimentally \tk{right? Can't seem to find any actual experimental evidence for the existence of the ggh loop}; Confirming its existence is an important verification of the SM.
% 
