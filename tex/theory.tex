...
% % ____________________________________________________________________________
% \subsubsection{The \texorpdfstring{\kappaframework}{kappa-framework}}
...
% 
% While the model allows simultaneous variation of all three coupling modifiers, only simultaneous variations of $\kappat$ and $\cg$, and of $\kappat$ and $\kappab$ are considered.
% 
