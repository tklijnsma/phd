...
For the variations of $\kappab$ and $\kappac$, the terms related to the interference with the top quark break the ratio-dependency observed in Equation~(\ref{eq:interpretation-shape-ktcg}).
% 
