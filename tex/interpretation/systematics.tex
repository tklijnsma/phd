...
% 
As the resummation is subject to choice of the resummation scale $Q$, also $Q$ is varied between $0.5$, $1$, and $2$ times its nominal value, while $\muR$ and $\muF$ are kept at their respective central values.
% 
...
% 
On the variations described above, the so-called envelop is applied: the asymmetric uncertainty up (down) is taken to be the difference between the maximum (minimum) variation and the central variation.
% 
...
% 
For the variations of $\kappab$ and $\kappac$, the scale uncertainties become larger further away from the region of the resummation and closer to $\mh$, as is expected.
% 
...
\hline
\input{img/interpretation/other/errors_yukawa_yukawa.tex}
\hline
\end{tabular}
\end{table}
...
\hline
\input{img/interpretation/other/errors_tophighpt_tophighpt.tex}
\hline
\end{tabular}
\end{table}
...
% 
The size of the bin-to-bin correlations is theoretically as ill-understood as the missing higher order contributions%
% 
\footnote{%
