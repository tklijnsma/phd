...
% 
Following the prescription in Ref.~\cite{Hansen:LShape}, it is found that no regularization term for the unfolding procedure was needed.
...
% 
However, due to constraints on available computing time, it is necessary to perform a binned fit of the distribution of $\mathcal{O}$ rather than an unbinned fit.
