\section{Determination of the strong coupling constant \texorpdfstring{$\asmz$}{alphas(mZ)} from measurements of the total cross section for top-antitop quark production}
