\subsection{Determination of \texorpdfstring{$\as$}{alphas} from \texorpdfstring{$\ttbar$}{tt} cross section measurements}
...
\begin{table*}[ht]
    ...
    \topcaption{
        ...
        small (see\ Ref.~\cite{Johnson:1988bx}) that no beam energy uncertainty is
...
Table~\ref{tab:pdf-fit-ttbar-choices} summarizes what data has been
...
%
\footnote{%
    As this work was being completed the
...
% and the $x$-dependence of the PDFs, see\ Table~\ref{tab:includedpredictions}
.
%
