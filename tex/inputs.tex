...
% up to which the detector inefficiency is still negligible,
% 
...
Because of its comparatively high event count at higher transverse momentum, the $\hgg$ decay channel is the most finely binned in terms of $\pth$, and gives the leading contribution to the overall precision of the combination.
% 
...
The individual $\hbb$ analysis originally concerned only an inclusive measurement; the differential measurement was created specifically for the purpose of this combination. 
% 
...
\begin{table*}[htb]
    ...
    \topcaption{
        ...
        The $\hbb$ measurement is carried out only at large $\pth$.
        }
...
\begin{table}[htb]
    \centering
    \topcaption{As Table~\ref{tab:binningpth}, but now concerning the $\njets$ binning.}
...
\begin{table*}[htb]
    \centering
    \topcaption{As Table~\ref{tab:binningpth}, but now concerning the $\absy$ binning.}
...
\begin{table*}[h!]
    \centering
    \topcaption{As Table~\ref{tab:binningpth}, but now concerning the $\ptjet$ binning.}
